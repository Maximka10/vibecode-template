...
export type SectionType = "hero"|"stats"|"about"|"gallery"|"services"|"hosting-service"|"templates-gallery"|"calculator"|"footer"|"reviews";
export interface Section { id: string; type: SectionType; content: Record<string, unknown> }
